...
(
    ...
    "CTM_LOGIN"        VARCHAR,
    "CTM_PROVIDER_ID"  VARCHAR NOT NULL,
    "CTM_BIRTH_DATE"   DATE
);

CREATE TABLE IF NOT EXISTS "TOKENS"
(
    "TKN_ID"     INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
    "TKN_CTM_ID" INT     NOT NULL,
    FOREIGN KEY (TKN_CTM_ID) references CUSTOMERS (CTM_ID)
);

CREATE TABLE IF NOT EXISTS "PASSWORD_DATA"
(
    "PAS_ID"           INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
    "PAS_PROVIDER_ID"  VARCHAR NOT NULL,
    "PAS_PROVIDER_KEY" VARCHAR NOT NULL,
    "PAS_HASH"         VARCHAR NOT NULL,
    "PAS_PASSWORD"     VARCHAR NOT NULL,
    "PAS_SALT"         VARCHAR
);

CREATE TABLE IF NOT EXISTS "OAUTH2_DATA"
(
    "OAU_ID"           INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
    "OAU_PROVIDER_ID"  VARCHAR NOT NULL,
    "OAU_PROVIDER_KEY" VARCHAR NOT NULL,
    "OAU_TOKEN"        VARCHAR NOT NULL,
    "OAU_TOKEN_TYPE"   VARCHAR,
    "OAU_EXPIRATION"   INTEGER
);

CREATE TABLE IF NOT EXISTS "USERS"
(
    "USR_ID"           INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
    "USR_PROVIDER_ID"  VARCHAR NOT NULL,
    "USR_PROVIDER_KEY" VARCHAR NOT NULL,
    "USR_EMAIL"        VARCHAR NOT NULL,
    "USR_LOGIN_DATE"   DATE NOT NULL
);
