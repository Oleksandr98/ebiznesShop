...
import models.repository.{TokenRepository, UserRepository}
...
abstract class SilhouetteController(override protected val controllerComponents: DefaultSilhouetteControllerComponents)
  ...
  def authTokenRepository: TokenRepository = controllerComponents.authTokenRepository
...
trait SilhouetteComponents {
  ...
  def authTokenRepository: TokenRepository
