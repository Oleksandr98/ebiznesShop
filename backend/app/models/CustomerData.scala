...
case class CustomerData(id: Long, name: String, surname: String, status: String, createDate: Option[Date], providerKey: String,
                        modifyDate: Option[Date], closureDate: Option[Date], login: String, birthDate: Date)
